...
const cacheName = 'Fixit10CalebG-2020-11-24 11:53:52.130227'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit10CalebG'.length) === 'Fixit10CalebG') {
